...
//				}
		...
		public:
			...
			// REG_RSSI_AVG_WINDOW
			constexpr static uint8_t SPECTRAL_SCAN_WINDOW_DEFAULT           = (0x05 << 2); //  7     0   default RSSI average window
			...
			constexpr static uint8_t LR_FHSS_GRID_STEP_FCC                  = (0x00UL << 0);   //  7     0     LR FHSS step size: 25.390625 kHz (FCC)
			constexpr static uint8_t LR_FHSS_GRID_STEP_NON_FCC              = (0x01UL << 0);   //  7     0                        3.90625 kHz (non-FCC)
			constexpr static uint8_t LR_FHSS_HOPPING_DISABLED               = (0x00UL << 0);   //  7     0     LR FHSS hopping: disabled
